    ...
    <div className={`app-shell ${mode === "exec" ? "exec-shell" : ""}`}>
      {mode === "director" ? (
        <>
          ...
          {showScheduleChecks && <ScheduleChecksDialog checks={warnings} loading={!hydrated} error={loadError} onReview={(target) => { setShowScheduleChecks(false); openScheduleReview(target); }} onClose={() => setShowScheduleChecks(false)} />}
        </>
      ) : (
